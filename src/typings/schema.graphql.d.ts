...
type Vtex_Item = {
  ...
  priceDefinition: Maybe<Vtex_PriceDefinition>;
};
...
type Vtex_PriceDefinition = {
  calculatedSellingPrice: Scalars['Float'];
  sellingPrices: Array<Vtex_SellingPrice>;
  total: Scalars['Float'];
};

type Vtex_SellingPrice = {
  quantity: Scalars['Float'];
  value: Scalars['Float'];
};
...
type CmsPlpFieldsEnum =
  ...
  | 'parameters___collection___brandId'
  | 'parent___id'
  | 'parent___parent___id'
  | 'parent___parent___parent___id'
  | 'parent___parent___parent___children'
